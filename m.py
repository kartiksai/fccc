...
bot = telebot.TeleBot('8111758180:AAF0JYfy_xLSaXFAPxkElCpmSmAkuVUZjEs')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @PRO_GAMER_VIP_OWNER❄."
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 1000:
                ...
                response = f"🚀𝘼𝙩𝙩𝙖𝙘𝙠 𝙤𝙣 ☄️{target}\n\n🏖️𝙋𝙤𝙧𝙩: {port}\n⌚𝙏𝙞𝙢𝙚: {time} 𝙨𝙚𝙘.\n🎉𝘾𝙤𝙢𝙥𝙡𝙚𝙩𝙚𝙙 🎊𝙎𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮🥳"
        else:
            response = "✅ Usage :- /attack <target> <port> <time>"  # Updated command syntax
    else:
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /attack command.                                                                          DM TO BUY ACCESS:- @PRO_GAMER_VIP_OWNER")
...
Buy From :- @PRO_GAMER_VIP_OWNER
Official Channel :- https://t.me/GODMODBYRAVI
'''
...
𝙀𝙭𝙖𝙢𝙥𝙡𝙚: 20.235.94.237 17870 180
🤖Try To Run This Command : /help 
✅BUY :- @PRO_GAMER_VIP_OWNER'''
    bot.reply_to(message, response)
...
3. MAKE SURE YOU JOINED https://t.me/GODMODBYRAVI OTHERWISE NOT WORK
